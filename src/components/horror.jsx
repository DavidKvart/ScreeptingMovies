    ...
    return ( 
        ...
        <tbody className="tableBody">
            {tempArray.map((movie)=>{
                let icon='error';
                if(movie.like)
                    icon=<i onClick={(id,genre)=> props.changeLike(movie.id,'horror')} className="bi bi-heart-fill"></i>;
                else
                    icon=<i onClick={(id,genre)=> props.changeLike(movie.id,'horror')} className="bi bi-heart"></i>;
                ...
                return(
                    ...
                    <td>{movie.rating}</td>
                    <td>{icon}</td>
                    <td><button className="btn btn-outline-dark" onClick={(id,genre)=> props.del(movie.id,'horror')} >remove</button></td>
                    </tr>
